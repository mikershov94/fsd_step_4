...
import {ControlSliderAlone} from '../components/control__slider';
import {ProgressBarFillAlone} from '../components/progress-bar__fill';
...
import {OutputFieldAlone} from '../components/output__field';
